...
let TemporalExplorer = exports.TemporalExplorer = TemporalExplorer_1 = class TemporalExplorer {
    ...
    explore() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.worker = yield worker_1.Worker.create(Object.assign(Object.assign({}, workerConfig), workerOptions));
        });
    }
    ...
    handleActivities() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.getActivityClasses().forEach((wrapper) => {
                const { instance } = wrapper;
                const isRequestScoped = !wrapper.isDependencyTreeStatic();
                this.metadataScanner.scanFromPrototype(instance, Object.getPrototypeOf(instance), (key) => {
                    if (this.metadataAccessor.isActivity(instance[key])) {
                        if (isRequestScoped) {
                            this.logger.warn(`Request-scoped activities are not yet fully supported. Activity "${key}" from class "${instance.constructor.name}" may not work correctly.`);
                        }
